...
$r = new Router();
//addRoute(url, action, controller, method)
//home//
...
// $r->addRoute("author/:authorId", "GET", "AuthorController", "listByAuthorId");
// $r->addRoute("authors/:id", "GET", "AuthorController", "detailsById");
